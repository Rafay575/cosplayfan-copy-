  ...
  return (
    <>
      {state().isSignupModalOpen && (
        <div class="backdrop fixed h-screen overflow-y-auto overflow-x-hidden  top-0 bottom-0 left-0 right-0">
          <div>
                ...
                <form class="space-y-6">
                  ...
                  <div class="flex items-start">
                    ...
                    <div class="ml-1 text-sm">
                      <label
                        for="terms"
                        class="block mb-2 text-[16px] leading-[24px] text-white font-[500]"
                      >
                        Sign Up For All Latest Updates & Exclusive Promotion
                        From The SinParty Team
                      </label>
                    </div>
                  </div>
                  ...
                  <div>
                    <p class="text-[16px] text-center font-[500] text-[#BFBFBF] leading-normal">
                      By Registering Your Accept Our{" "}
                      <strong class="text-[16px] font-[500] text-white leading-normal">
                        Privacy Policy
                      </strong>
                    </p>
