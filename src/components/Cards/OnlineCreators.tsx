            ...
            <div class="w-full container lg:max-w-full lg:px-14 px-4 py-3 md:py-10 mx-auto">
                <div class="flex items-center justify-center md:justify-between">
                    <p class="text-white font-clash-display-variable font-bold text-[26px] lg:text-[52px]">
                        Online{" "}
                        <span class="bg-gradient-to-r from-cyan-400 to-yellow-300 text-transparent bg-clip-text font-clash-display-variable font-bold text-[26px] lg:text-[52px]">
                            Creators
                        </span>
                    </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-6 md:mt-8">
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((_) => (
                        <div class="relative mt-3 group">
                            ...
                            />
                            <div
                                class={`rounded-b-lg absolute w-full bottom-0 group-hover:bg-gradient-to-r from-purple-600 to-blue-600 group-hover:backdrop-blur-2 bg-black/70
                                }`}
                            >
