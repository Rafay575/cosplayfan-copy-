          ...
          <div>
            ...
            >
              <div class="flex items-center justify-between p-2">
                ...
                <img class="w-[27px] h-[27px]" src={flame} alt="" />
              </div>
              <p class="text-white font-[400] leading-[24px] text-[14px] p-2">
                Dressing up as a Genshin Impact character is so awsome to me.
                Come check out my private pics and if I’m online come say
                hello:)
              </p>
              <div class="flex items-center justify-between p-2">
