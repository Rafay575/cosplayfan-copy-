    ...
    return (
        <div class="container lg:max-w-full lg:px-14 py-4 mx-auto px-4 h-full">
            <div class="flex">
                <div class="md:w-1/2">
                    <div class="lg:w-3/4">
                        <h1 class="text-cyan-400 text-shadow font-semibold text-3xl lg:text-[30px]">
                            FEATURED CREATOR
                        </h1>
                        <h1 class="text-white text-shadow font-bold text-3xl  lg:text-[60px] mt-8">
                            Candice Nice 
                            <span class="lg:text-[48px]">as</span>
                        </h1>
                ...
                <div class="w-[600px] h-[335.57px] hidden md:flex relative items-center justify-start">
                    <img
