...
const Header = () => {
    return (
        <div class="flex items-center justify-between container lg:max-w-full lg:px-14 mb-12 pt-8 py-4 mx-auto px-4 bg-transparent">
            ...
            <div class="flex items-center justify-center gap-6 md:gap-3">
                ...
                <button class="w-[86px] h-[28px] md:w-28 md:h-7 flex-shrink-0 rounded-md border bg-red-500 bg-opacity-7 shadow bg-blur text-white text-shadow font-clash font-medium text-xs">
                    BUY TOKENS
                </button>
                <button
                    onclick={actions.toggleLoginModal}
                    class="w-[90px] h-[30px] hidden md:block flex-shrink-0 rounded-md border border-white bg-gradient-to-r from-purple-600 to-blue-600 shadow text-white text-shadow font-clash font-medium text-xs"
                >
                    SIGN IN
                </button>
                <button class="block md:hidden flex-shrink-0 ">
